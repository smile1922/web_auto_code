...
public class TestingpaiTest {
    ...
    public static void main(String[] args) {
        ...
        // driver.findElement(By.id("nameOrEmail")).sendKeys("18813006679");
        //driver.findElement(By.cssSelector("#nameOrEmail")).sendKeys("18813006679");
        //driver.findElement(By.cssSelector("input[autofocus='autofocus']")).sendKeys("18813006679");
        //driver.findElement(By.cssSelector("input[placeholder='用户名/邮箱/手机号']")).sendKeys("18813006679");
        //多属性
        //driver.findElement(By.cssSelector("input[autofocus='autofocus'][placeholder='用户名/邮箱/手机号']")).sendKeys("18813006679");
